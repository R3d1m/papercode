  ...
  try {
    ...
    if (result.rows.length > 0) {
      const submissions = result.rows.map(r => ({
        ...
        studentAvatar: r.student_avatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150',
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    const sub = {
      ...
      studentAvatar: studentAvatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150',
